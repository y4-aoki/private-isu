...
ssh -i isucon.pem isucon@52.195.180.147 "$analyze_access" | tee logs/nginx/digest.log.$now
ssh -i isucon.pem isucon@52.195.180.147 "$analyze_slow_query" | tee logs/mysql/digest.log.$now

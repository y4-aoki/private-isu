...
ssh -i isucon.pem isucon@18.181.244.100 "$analyze_access" | tee logs/nginx/digest.log.$now
ssh -i isucon.pem isucon@18.181.244.100 "$analyze_slow_query" | tee logs/mysql/digest.log.$now
